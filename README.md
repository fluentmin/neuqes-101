...
| 25 | — | [![Open](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/yoon-gu/neuqes-101/blob/master/25_gpt2_finetune/25_gpt2_finetune.ipynb) | gpt2 (사전학습) — **continued pretraining** (계속 사전학습 / continual learning, *같은 CausalLM task 를 새 데이터로 더 학습*. SFT 아님) | BPE (GPT2) | TinyStories (Ch 24와 동일) | `Linear(H,V)` (LM head 그대로) | softmax | `CrossEntropyLoss` (next-token) | shifted token ids |
