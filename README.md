...
| 23 | — | [![Open](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/yoon-gu/neuqes-101/blob/master/23_ko_tiny_gpt/23_ko_tiny_gpt.ipynb) | small GPT2 (직접, scratch — Ch 21의 한국어판) | BBPE (직접 학습) | 한국어 작은 corpus (작성 시 확정) | `Linear(H,V)` | softmax + sampling(top-k/top-p) | `CrossEntropyLoss` (next-token) | shifted token ids |
